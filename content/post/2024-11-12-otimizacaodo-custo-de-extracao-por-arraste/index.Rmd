...
```{r funcao, include=TRUE, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r res_mod_probl_ori, include=TRUE, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE }
...
```{r reduz_res_probl_origin, include=TRUE, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE }
...
```{r restri_cen2_res, include=TRUE, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r cria_mapa, include=TRUE, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE }
...
knitr::include_graphics("./images/p_mediana_T67_post2.png")
